...
Язык документа: [EN](README.md) | [RU](README.ru.md) | [JA](README.ja.md)
...
-**Лицензия**: Этот проект и все его содержимое лицензированы на условиях [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License (BY-NC-SA 4.0)](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.ru). Это означает:
