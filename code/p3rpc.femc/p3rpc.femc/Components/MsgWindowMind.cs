...
namespace p3rpc.femc.Components
{
    public class MsgWindowMind : ModuleBase
    {
        ...
        {
            self->OuterBorderColor.SetColor(_context._config.MindWindowOuterBorder);
            self->InnerContentsColor.SetColor(_context._config.MindWindowInnerColor);
            self->OutsideMistColor.SetColor(_context._config.MindWindowOuterHaze);
